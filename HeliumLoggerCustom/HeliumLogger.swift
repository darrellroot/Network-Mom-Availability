...
public class HeliumLogger {
    ...
    public static var logData: [LoggerMessageType:RRDBuffer<String>] = [
        LoggerMessageType.entry:RRDBuffer<String>(count: 1000), LoggerMessageType.exit:RRDBuffer<String>(count: 1000),
        LoggerMessageType.debug:RRDBuffer<String>(count: 1000), LoggerMessageType.verbose:RRDBuffer<String>(count: 1000),
        LoggerMessageType.info:RRDBuffer<String>(count: 1000), LoggerMessageType.warning:RRDBuffer<String>(count: 1000),
        LoggerMessageType.error:RRDBuffer<String>(count: 1000),
    ]
...
extension HeliumLogger : Logger {
    ...
    public func log(_ type: LoggerMessageType, msg: String,
        ...
        HeliumLogger.logData[type]!.insert(message)
        doPrint(message)
    }
