//
//  CoreMonitorIPv4+CoreDataProperties.swift
...
extension CoreMonitorIPv4 {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<CoreMonitorIPv4> {
        return NSFetchRequest<CoreMonitorIPv4>(entityName: "CoreMonitorIPv4")
    }
